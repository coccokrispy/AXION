...
const S = {
  page: {
  minHeight: "100vh",
  background: "linear-gradient(180deg, #000000 0%, #020617 45%, #000000 100%)",
  color: "#f8fafc",
  ...
  gap: 7,
  padding: "16px 10px",
  background: "linear-gradient(145deg, #050816, #0b1120)",
  ...
  gap: 7,
  padding: "16px 10px",
  background: "linear-gradient(145deg, rgba(20,83,45,0.95), rgba(0,0,0,0.98))",
  border: "1px solid #4ade80",
  borderRadius: 20,
  cursor: "pointer",
  color: "#4ade80",
  fontFamily: "monospace",
  boxShadow: "0 0 24px rgba(74,222,128,0.18), inset 0 0 18px rgba(74,222,128,0.08)",
},
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 10, marginBottom: 14 },
  card: {
  background: "linear-gradient(145deg, rgba(5,10,20,0.96), rgba(0,0,0,0.96))",
  border: "1px solid #1f2937",
  borderRadius: 22,
  padding: 18,
  boxShadow: "inset 0 0 22px rgba(255,255,255,0.03), 0 10px 30px rgba(0,0,0,0.35)",
},
  ...
  panel: {
  background: "linear-gradient(145deg, rgba(2,6,23,0.98), rgba(0,0,0,0.98))",
