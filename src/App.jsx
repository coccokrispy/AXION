...
function addSupplement() {
  ...
  setMySupplements(prev => [...prev, {
    id: uid(),
    name: pendingSupp.name,
    category: pendingSupp.category,
    dose: suppForm.dose || "—",
    unit: suppForm.dose ? suppForm.unit : "",
    schedule: suppForm.schedule,
    time: suppForm.time,
  }]);
  setSuppView("items");
  setPendingSupp(null);
...
function saveSuppEdit() {
  setMySupplements(prev => prev.map(s =>
    s.id === editingSupp.id
      ? { ...s, dose: suppForm.dose || "—", unit: suppForm.dose ? suppForm.unit : "", schedule: suppForm.schedule, time: suppForm.time }
      : s
  ));
  setEditingSupp(null);
  setSuppView("my");
...
const S = {
  page: {
  minHeight: "100vh",
  background: "radial-gradient(circle at top, rgba(22,163,74,0.18) 0%, #020403 24%, #000000 72%)",
  color: "#f8fafc",
...
tab: {
  ...
  gap: 8,
  padding: "17px 8px",
  background: "linear-gradient(145deg, #000000, #020806)",
  border: "1px solid rgba(74,222,128,0.18)",
  borderRadius: 20,
  cursor: "pointer",
  color: "#cbd5e1",
  fontFamily: "monospace",
  boxShadow: "inset 0 0 18px rgba(74,222,128,0.03)",
  ...
  gap: 8,
  padding: "17px 8px",
  background: "linear-gradient(145deg, rgba(0,0,0,1), rgba(5,46,22,0.92))",
  border: "1px solid #4ade80",
  borderRadius: 20,
  cursor: "pointer",
  color: "#4ade80",
  fontFamily: "monospace",
  boxShadow: "0 0 24px rgba(74,222,128,0.35), inset 0 0 26px rgba(74,222,128,0.12)",
  transform: "translateY(-2px)",
  transition: "all 0.18s ease",
},
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 10, marginBottom: 14 },
  card: {
  background: "linear-gradient(145deg, rgba(0,0,0,0.98), rgba(2,8,5,0.98))",
  border: "1px solid rgba(74,222,128,0.24)",
  borderRadius: 22,
  padding: 18,
  boxShadow: "0 0 22px rgba(74,222,128,0.08), inset 0 0 18px rgba(255,255,255,0.025)",
},
 ...
 panel: {
  ...
  padding: 20,
  marginBottom: 18,
  boxShadow: "0 0 26px rgba(74,222,128,0.10), inset 0 0 24px rgba(74,222,128,0.035)",
},
...
goalCard: {
  ...
  alignItems: "center",
  gap: 12,
  background: "radial-gradient(circle at center, rgba(74,222,128,0.15), rgba(0,0,0,0.98) 58%)",
  border: "1px solid rgba(74,222,128,0.35)",
  borderRadius: 24,
  padding: "26px 18px 20px",
  marginBottom: 20,
  boxShadow: "0 0 36px rgba(74,222,128,0.18), inset 0 0 30px rgba(74,222,128,0.06)",
},
